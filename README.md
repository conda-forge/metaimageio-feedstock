...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/metaimageio-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14932&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/metaimageio-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `metaimageio` can be installed with:

```
conda install metaimageio
```

It is possible to list all of the versions of `metaimageio` available on your platform with:
